...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if email and password:
            ...
            raise serializers.ValidationError("Um e-mail e uma senha são necessários.")

        if not user:
            # Se a autenticação falhou, tentar encontrar o usuário para dar um erro mais específico
            try:
        ...
        # Se o usuário foi encontrado por authenticate, mas está inativo por algum motivo (ex: admin desativou)
